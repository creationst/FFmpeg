...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch arm64 -mios-version-min=6.0' --extra-cxxflags='-arch arm64 -mios-version-min=6.0' --extra-ldflags='-arch arm64 -mios-version-min=6.0' --prefix=/Users/devmarcos/Documents/GitHubRepos/CreationMedia/external/FFmpeg/thin/arm64
prefix=/Users/devmarcos/Documents/GitHubRepos/CreationMedia/external/FFmpeg/thin/arm64
...
CXX=g++
AS=gas-preprocessor.pl -arch aarch64 -as-type apple-clang -- xcrun -sdk iphoneos clang
LD=xcrun -sdk iphoneos clang
DEPCC=xcrun -sdk iphoneos clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl -arch aarch64 -as-type apple-clang -- xcrun -sdk iphoneos clang
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar

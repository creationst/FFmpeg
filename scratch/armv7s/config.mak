...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7s --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch armv7s -mios-version-min=6.0' --extra-cxxflags='-arch armv7s -mios-version-min=6.0' --extra-ldflags='-arch armv7s -mios-version-min=6.0' --prefix=/Users/devmarcos/Documents/GitHubRepos/CreationMedia/external/FFmpeg/thin/armv7s
prefix=/Users/devmarcos/Documents/GitHubRepos/CreationMedia/external/FFmpeg/thin/armv7s
...
SRC_PATH=/Users/devmarcos/Documents/GitHubRepos/CreationMedia/external/FFmpeg/ffmpeg-2.5
...
CFLAGS=  -arch armv7s -mios-version-min=6.0 -mcpu= -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS= -arch armv7s -mios-version-min=6.0 -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch armv7s -mios-version-min=6.0 -mcpu= -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
EXTRALIBS=-framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreGraphics -liconv -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
